...
@Autonomous(name = "State: WITH WAIT Blue Diagonal", group = "State")
//@Disabled
public class Auto_blue_diagonal_with_WAIT extends OpMode {
      ...
      case STATE_DRIVE_TO_BEACON_TWO:
        ...
        if (mStateTime.time() > .50) {
          ...
          telemetry.addData("drive_to", "beacon_2", side_right.getCurrentPosition());
            ...
            int b2COUNTS = myUtils.getNewCounts(107); //48" - 1/14/17
            if (mShifted == true){
              b2COUNTS = myUtils.getNewCounts(101); //if goes into STATE SEARCH
            }
